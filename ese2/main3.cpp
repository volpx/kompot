...
int main()
{
	std::cout << "Hartree-Fock Be atom 8 gaussians uncontracted" << std::endl;
	...
	// Basis
	constexpr uint32_t Nbase = 8;
	constexpr double a[Nbase] = {0.7064859542e2, 0.1292782254e2, 0.3591490662e1, 0.1191983464e1, 0.3072833610e1, 0.6652025433, 0.2162825386, 0.8306680972e-1};
